...
## Project Structure
    ...
    ├── jaysonlinestore_33798  # Django project configurations
...
1. Clone this repo and `cd jaysonlinestore_33798`
...
2. Clone this repo and `cd jaysonlinestore_33798`
